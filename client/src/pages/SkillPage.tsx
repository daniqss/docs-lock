    ...
    <>
      ...
      <main className="mt-20 mb-12 mx-4 flex-1">
        ...
        <section className="flex flex-1 gap-4">
          {/* left column */}
          <section className="w-1/3 bg-white p-4 rounded-lg items-center max-h-100 overflow-y-auto">
            <SectionList
          ...
          <section className="w-2/3 bg-secondary p-4 rounded-lg items-center flex-col max-h-100">
            {/* right column */}
            <section className="items-center max-h-70 overflow-y-auto">
              {!isSectionLoading &&
                !sectionError &&
